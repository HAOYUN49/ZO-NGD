...
def run_inference_on_image(image):
  ...
  with tf.Session() as sess:
    ...
    dat = np.array(Image.fromarray(imageio.imread(image)).resize((299,299)))
...
def readimg(ff):
  #f = "../../blackbox/imagenetdata/imgs/"+ff
...
if __name__ == '__main__':
  ...
  parser.add_argument('--model_dir', type=str, default='../imagenet',
    help="""Path to classify_image_graph_def.pb, """
         """imagenet_synset_to_human_labels_map.txt, and"""
         """imangenet_2012_challenge_label_map_proto.pbtt.""")
  ...
  FLAGS = Namespace(model_dir="../imagenet")
