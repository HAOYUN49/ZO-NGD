...
from l2_blackbox_attack_second_cifar import LADMMBB
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--maxiter", type=int, default=100, help="max iterations per bss")
    parser.add_argument("-is", "--iteration_steps", type=int, default=100, help="number of iteration")
    parser.add_argument("-ro", "--ro", type=float, default=2000, help="value of ro")
    ...
    parser.add_argument("-sd", "--seed", type=int, default=72221,
    ...
    parser.add_argument("-al", "--alpha", type=float, default=50, help='alpha hyperparameter')
    ...
    parser.add_argument("-ga", "--gama", type=float, default=10, help='gama hyperparameter')
    parser.add_argument("-ep", "--epi", type=float, default=0.2, help='epison hyperparameter')
