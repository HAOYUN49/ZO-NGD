...
from l2_blackbox_attack_second_imagenet import LADMMBB
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--maxiter", type=int, default=4000, help="max iterations per bss")
    ...
    parser.add_argument("-imgsd", "--seed_imagenet", type=int, default=12,
                        help='random seed for pulling images from ImageNet test set')
    parser.add_argument("-sd", "--seed", type=int, default=393,
    ...
    parser.add_argument("-al", "--alpha", type=float, default=800, help='alpha hyperparameter')
